...
public class FollowBuddyComposer extends ICompose {

	private int FollowId;
	
	public FollowBuddyComposer(int followId) {
		super();
	...
	public Response compose() {
		response.init(Outgoing.FollowBuddy);
		response.appendBoolean(false);
		response.appendInt32(this.FollowId);
		return response;
	}
