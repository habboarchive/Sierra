...
public class RoomRightsComposer extends ICompose {

	private int RightId;
	
	public RoomRightsComposer(int rightId) {
		super();
	...
	public Response compose() {
		response.init(Outgoing.LoadRightsOnRoom);
		response.appendInt32(this.RightId);
		return response;
	}
