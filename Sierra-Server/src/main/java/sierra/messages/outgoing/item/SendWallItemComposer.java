...
public class SendWallItemComposer extends ICompose {

	private WallItem WallItem;
	private int OwnerId;

	public SendWallItemComposer(WallItem wallItem, int ownerId) {
		super();
	...
	public Response compose() {
		response.init(Outgoing.SendWallItem);
		response.appendBody(this.WallItem);
