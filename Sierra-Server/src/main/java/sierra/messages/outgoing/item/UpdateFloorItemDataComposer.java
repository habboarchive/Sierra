...
public class UpdateFloorItemDataComposer extends ICompose {

	private int Id;
	private String ExtraData;
	
	public UpdateFloorItemDataComposer(int id, String extraData) {
		super();
		this.Id = id;
	...
	public Response compose() {
		response.init(Outgoing.UpdateFloorExtraData);
		response.appendString(Id);
